    ...
    <div class="flex flex-wrap w-full justify-center items-center pt-10">
        <div class="flex flex-wrap max-w-xl">
            ...
            <div class="p-2 w-full mt-4">
                <button @click.prevent="loginUser" type="submit" class="flex text-white bg-indigo-500 border-0 p-2 px-8 focus:outline-none hover:bgindigo-600 rounded text-lg">Login</button>
            </div>
        </div>
    </div>
</template>
